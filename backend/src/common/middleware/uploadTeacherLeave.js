...
const uploadRoot = path.join(process.cwd(), "uploads", "teacher-leaves");
...
const fileFilter = (_req, file, cb) => {
  const okMime = ["application/pdf", "image/jpeg", "image/png", "image/webp", "image/jpg"].includes(
    file.mimetype || ""
  );
...
export const uploadTeacherLeaveFile = multer({
  storage,

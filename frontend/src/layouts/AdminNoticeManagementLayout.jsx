...
function AdminNoticeManagementLayout() {
  return (
    <div className="w-full max-w-7xl space-y-8 pb-8">
      <nav
        ...
        aria-label="Notice management sections"
      >
        <NavLink
          to="create"
          className={({ isActive }) =>
            `${tabBase} ${
              isActive
                ? "bg-gradient-to-r from-brand-600 to-fuchsia-600 text-white shadow-md shadow-brand-500/25"
                : "text-slate-600 hover:bg-slate-50 hover:text-slate-900"
            }`
          }
        >
          <BellPlus className="h-4 w-4 shrink-0" strokeWidth={2.5} />
          Create notice
        </NavLink>
        <NavLink
          to="registered"
...
export default AdminNoticeManagementLayout;

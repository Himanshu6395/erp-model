...
function AdminTimetableManagementLayout() {
  return (
    <div className="w-full max-w-7xl space-y-8 pb-8">
      <nav
        ...
        aria-label="Timetable management sections"
      >
        <NavLink
          to="create"
          className={({ isActive }) =>
        ...
        >
          <CalendarPlus2 className="h-4 w-4 shrink-0" strokeWidth={2.5} />
          Create timetable
        </NavLink>
        <NavLink
          to="registered"
...
export default AdminTimetableManagementLayout;

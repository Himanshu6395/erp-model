...
export default function SecuritySettingsPage() {
  ...
  const handleChangePassword = async () => {
    ...
    setSaving(true);
    try {
      await superAdminSettingsService.changePassword({
  ...
  const handleLogoutAll = async () => {
    setLoggingOut(true);
    try {
      await superAdminSettingsService.logoutAllDevices();
  ...
  return (
    <Stack spacing={3}>
      <SettingsSectionCard title="Session info" subtitle="Recent authentication activity for your account.">

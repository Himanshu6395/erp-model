...
export default function EmailSmtpSettingsPage() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await superAdminSettingsService.updateSmtp(form);
  ...
  const handleTest = async () => {
    setTesting(true);
    try {
      const res = await superAdminSettingsService.sendTestEmail();
  ...
  return (
    <SettingsSectionCard
      ...
      subtitle="Configure outbound email for system notifications."
      actions={

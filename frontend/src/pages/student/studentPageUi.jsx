...
export const btnSecondary =
  "inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-brand-200 hover:bg-brand-50/50 disabled:opacity-50";
...
export function DataTable({ children }) {
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-200/80 ring-1 ring-slate-100">
      <div className="student-table-scroll max-h-[min(70vh,720px)] overflow-auto">{children}</div>
    </div>
  );
}
...
export function InfoGrid({ items }) {
  return (
    <div className="grid gap-3 rounded-2xl border border-brand-100/80 bg-gradient-to-br from-brand-50/80 to-indigo-50/40 p-4 sm:grid-cols-2 lg:grid-cols-4">
